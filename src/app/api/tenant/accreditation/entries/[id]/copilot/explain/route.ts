...
import { generateEntryExplainSuggestion } from "@/lib/accreditation/accreditation-copilot-service";
import {
...
export async function POST(
  ...
  const result = await generateEntryExplainSuggestion(id, session.tenantId, session.userId, session.role);
