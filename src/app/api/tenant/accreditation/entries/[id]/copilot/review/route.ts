...
import { generateEntryReviewSuggestion } from "@/lib/accreditation/accreditation-copilot-service";
import {
...
export async function POST(
  ...
  const result = await generateEntryReviewSuggestion(id, session.tenantId, session.userId, session.role);
