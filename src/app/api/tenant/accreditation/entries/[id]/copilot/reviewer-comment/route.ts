...
import { generateEntryReviewerCommentSuggestion } from "@/lib/accreditation/accreditation-copilot-service";
import {
...
export async function POST(
  ...
  const result = await generateEntryReviewerCommentSuggestion(
    id,
    session.tenantId,
    session.userId,
    session.role,
