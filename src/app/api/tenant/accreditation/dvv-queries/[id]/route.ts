...
import { updateDvvQuery } from "@/lib/accreditation/workspace-reporting-service";
import {
...
export async function PATCH(
  ...
  const result = await updateDvvQuery(id, session.tenantId, parsedBody.body, session.userId, session.role);
