...
import { respondToDvvQuery } from "@/lib/accreditation/workspace-reporting-service";
import {
...
export async function POST(
  ...
  const result = await respondToDvvQuery(id, session.tenantId, parsedBody.body, session.userId, session.role);
