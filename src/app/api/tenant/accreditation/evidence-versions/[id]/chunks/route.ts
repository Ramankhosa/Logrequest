...
import { listEvidenceVersionChunks } from "@/lib/accreditation/accreditation-copilot-service";
import {
...
export async function GET(
  ...
  const result = await listEvidenceVersionChunks(id, session.tenantId, session.userId, session.role);
