...
import { extractEvidenceVersionForCopilot } from "@/lib/accreditation/accreditation-copilot-service";
import {
...
export async function POST(
  ...
  const result = await extractEvidenceVersionForCopilot(id, session.tenantId, session.userId, session.role);
