...
import { refreshInstitutionalDataSource } from "@/lib/accreditation/institutional-data-service";
import {
...
export async function POST(
  ...
  const result = await refreshInstitutionalDataSource(id, session.tenantId, session.userId, session.role);
