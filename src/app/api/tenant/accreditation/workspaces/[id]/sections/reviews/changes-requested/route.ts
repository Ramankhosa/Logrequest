...
import { requestChangesAssessmentWorkspaceSectionReview } from "@/lib/accreditation/workspace-service";
import {
...
export async function POST(
  ...
  const result = await requestChangesAssessmentWorkspaceSectionReview(
    id,
    session.tenantId,
    parsed.body,
    session.userId,
