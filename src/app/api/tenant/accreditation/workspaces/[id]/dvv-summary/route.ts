...
import { getWorkspaceDvvSummary } from "@/lib/accreditation/workspace-reporting-service";
import {
...
export async function GET(
  ...
  const result = await getWorkspaceDvvSummary(id, session.tenantId, session.userId, session.role);
