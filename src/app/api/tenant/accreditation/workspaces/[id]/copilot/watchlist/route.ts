...
import { generateWorkspaceWatchlistSuggestion } from "@/lib/accreditation/accreditation-copilot-service";
import {
...
export async function POST(
  ...
  const result = await generateWorkspaceWatchlistSuggestion(
    id,
    session.tenantId,
    session.userId,
    session.role,
