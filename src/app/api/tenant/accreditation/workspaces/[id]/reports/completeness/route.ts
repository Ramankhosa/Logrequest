...
import { getWorkspaceCompletenessReport } from "@/lib/accreditation/workspace-reporting-service";
import {
...
export async function GET(
  ...
  const result = await getWorkspaceCompletenessReport(id, session.tenantId, session.userId, session.role);
