...
import { getWorkspaceReadinessReport } from "@/lib/accreditation/workspace-reporting-service";
import {
...
export async function GET(
  ...
  const result = await getWorkspaceReadinessReport(id, session.tenantId, session.userId, session.role);
