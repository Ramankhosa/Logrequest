...
import { getWorkspaceEvidenceInventory } from "@/lib/accreditation/workspace-reporting-service";
import {
...
export async function GET(
  ...
  const result = await getWorkspaceEvidenceInventory(id, session.tenantId, session.userId, session.role);
