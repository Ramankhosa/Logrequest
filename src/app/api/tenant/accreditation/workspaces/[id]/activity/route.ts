...
import { getAssessmentWorkspaceActivitySinceLastVisit } from "@/lib/accreditation/workspace-service";
import {
...
export async function GET(
  ...
  const result = await getAssessmentWorkspaceActivitySinceLastVisit(
    id,
    session.tenantId,
    session.userId,
    session.role,
